...
def get_monthly_budget_list(request):
    ...
    sumOfPayments = payments.aggregate(Sum('instalment_amount')).get('instalment_amount__sum')
 
    sumOfIncome = income.aggregate(Sum('income_amount')).get('income_amount__sum')
